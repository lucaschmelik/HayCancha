...
namespace HayCancha.BE
{
    public abstract class AbstractDAL
    {
        ...
        private string RetornaNombrePC()
        {
            Process process = new Process();
            process.StartInfo.FileName = "cmd.exe";
            process.StartInfo.Arguments = "/c hostname";
        ...
        private string RetornaNombreUsuarioPC()
        {
            Process process = new Process();
            process.StartInfo.FileName = "cmd.exe";
        ...
        private void CreaBD()
        {
            ...
            process.StartInfo.Arguments = $"-S { RetornaNombrePC() }\\SQLEXPRESS -i {Environment.CurrentDirectory}\\base.sql -o {Environment.CurrentDirectory}\\output.txt";
            process.StartInfo.UseShellExecute = false;
            process.StartInfo.RedirectStandardOutput = true;
            process.Start();
            process.WaitForExit();
        ...
        private void CargarDatos()
        {
            ...
            process.StartInfo.FileName = "sqlcmd";
            process.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;
            process.StartInfo.Arguments = $"-S { RetornaNombrePC() }\\SQLEXPRESS -i {Environment.CurrentDirectory}\\data.sql -o {Environment.CurrentDirectory}\\outputdata.txt";
            process.StartInfo.UseShellExecute = false;
            process.StartInfo.RedirectStandardOutput = true;
            process.Start();
            process.WaitForExit();
